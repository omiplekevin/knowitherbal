...
<div class="row">
	<div class="col-md-4">
		...
		<div style = "text-align: justify">
			<p>&bull; “knowITherbal” is an application used by the botanists and future botanist, hikers, and common people for identifying herbal plant’s leaf captured by the application using the mobile phone camera and analyze the image by using some of the algorithms to identify the feature of the leaf.</p>
			<p>&bull; This website serves as a data source of the mobile application.</p>
			<p>&bull; The photos used by the application (both Web and Mobile) for reference came from different sites.</p>
			<p>&bull; The details for the plants are refered from <a href = "http://stuartxchange.com/CompleteList.html" target = "_blank">StuartXchange.</a></p>
		</div>
	</div>
	<div class="col-md-4">
		...
		<?php
			...
			$last_update = DB::query("SELECT * FROM `publishes` ORDER BY `id` DESC LIMIT 1")->execute()->as_array();
			...
			try
			{
				...
				echo "<strong><p>Last Publish: </strong>".date('F jS, Y - l g:ia', date_timestamp_get($date));
			}
			catch(Exception $e)
			{
