		...
		<div class="container">
			<div class="navbar-header">
				...
				<ul class="nav navbar-nav pull-right">
					<li class="dropdown">
						<a data-toggle="dropdown" class="dropdown-toggle" href="#"><?php echo 'Howdy visitor!' ?> <b class="caret"></b></a>
						...
						foreach($files as $file)
						{
							...
							<li class="<?php echo Uri::segment(2) == $section_segment ? 'active' : '' ?>">
								<?php echo Html::anchor('user/'.$section_segment, Html::img('assets/img/'.$icons[$i])."&nbsp&nbsp&nbsp&nbsp&nbsp".$section_title) ?>
							</li>
							<?php
							$i++;
						}
					?>
							<li><?php echo Html::anchor('admin/login', Html::img('assets/img/login.png')."&nbsp&nbsp&nbsp&nbsp&nbsp".'Login') ?></li>
						</ul>
					</li>
				</ul>
		</div>
